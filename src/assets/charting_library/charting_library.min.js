...
Datafeeds.UDFCompatibleDatafeed.prototype._initialize = function() {
  ...
  this._send(this._datafeedURL + '/api/udf/config')
    .done(function(response) {
...
Datafeeds.UDFCompatibleDatafeed.prototype.getMarks = function(symbolInfo, rangeStart, rangeEnd, onDataCallback, resolution) {
  if (this._configuration.supports_marks) {
    ...
    console.log(this.stockMarksType);
    ...
    if(this.stockMarksType === 'gap'){
      ...
      marksEndPoint = 'marksgreenarrows';
        ...
        marksEndPoint = 'markstoch307bull';
    } else {
      marksEndPoint = 'marks';
    }
      console.log(marksEndPoint);
    this._send(this._datafeedURL + '/api/udf/' + marksEndPoint, {
...
Datafeeds.UDFCompatibleDatafeed.prototype.getTimescaleMarks = function(symbolInfo, rangeStart, rangeEnd, onDataCallback, resolution) {
  if (this._configuration.supports_timescale_marks) {
    this._send(this._datafeedURL + '/api/udp/timescale_marks', {
      symbol: symbolInfo.ticker.toUpperCase(),
      from: rangeStart,
      to: rangeEnd,
      resolution: resolution
...
Datafeeds.UDFCompatibleDatafeed.prototype._symbolResolveURL = '/api/udf/symbols';
...
Datafeeds.UDFCompatibleDatafeed.prototype._historyURL = '/api/udf/history';
